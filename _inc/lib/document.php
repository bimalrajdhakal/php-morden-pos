		...
		if (!get_pcode() || !get_pusername() || get_pcode() == 'error' || get_pusername() == 'error') {
			...
			<body>
			    <section id=\"wrapper\">
			        ...
			        <div id=\"content\">
			            <p>Your purchase code is invalid. Claim a valid purchage code here: itsolution24bd@gmail.com</p>
			            <p>&mdash; <a target=\"_blink\" href=\"http://itsolution24.com\" title=\"ITsolution24.com\">ITsolution24.com</a></p>
			        </div>
			    </section>
			</body>
			</html>");
